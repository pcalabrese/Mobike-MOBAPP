 ...
 */
public class DownloadRoutesTask extends AsyncTask<String, Void, String> {
    private Fragment fragment;
    private Activity activity;
    private ProgressDialog progressDialog;

    public DownloadRoutesTask(Activity activity, Fragment fragment) {
    ...
    protected void onPostExecute(String result) {
        try{
            ...
            ((SearchFragment) fragment).showRouteList(json);
